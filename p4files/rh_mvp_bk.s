...
block SEM {
  ...
  domain GLOBAL {
    ...
    tcam MD_PRE_EXTRACT(%TX, %PTYPE) {
        ...
        1, 'b??_????_???? : %MD4[71:64], %NULL, %NULL, %NULL;
        0, 'b??_????_???? : %MD4[71:64], %NULL, %NULL, %NULL;
    }
    ...
    tcam PROFILE(%PTYPE_GROUP, %VSI_GROUP, %SEM_MD2, %PORT) {
        ...
        @12 { 'b??_????_????, 1, 'h????, 'b?? : 1; }
        @13 { 12, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @14 { 13, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @15 { 14, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @16 { 23, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @17 { 24, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @18 { 26, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @19 { 43, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @20 { 56, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @21 { 57, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @22 { 59, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @23 { 60, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @24 { 61, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @25 { 63, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        @26 { 366, 'b???_????_????, 'b????_????_?0?0_0001, 'b?? : 4; }
        ...
        @36 { 11, 'b???_????_????, 'b????_???1_?0?0_0001, 'b?? : 7; }
        @37 { 15, 'b???_????_????, 'b????_???1_?0?0_0001, 'b?? : 7; }
        @38 { 287, 'b???_????_????, 'b????_???1_?0?0_0001, 'b?? : 7; }
        @39 { 11, 'b???_????_????, 'b????_????_10?0_0001, 'b?? : 7; }
        @40 { 15, 'b???_????_????, 'b????_????_10?0_0001, 'b?? : 7; }
        @41 { 287, 'b???_????_????, 'b????_????_10?0_0001, 'b?? : 7; }
        @42 { 11, 'b???_????_????, 'b????_???0_00?0_0001, 'b?? : 8; }
        @43 { 15, 'b???_????_????, 'b????_???0_00?0_0001, 'b?? : 8; }
        @44 { 287, 'b???_????_????, 'b????_???0_00?0_0001, 'b?? : 8; }
        @45 { 1, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @46 { 11, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @47 { 12, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @48 { 13, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @49 { 14, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @50 { 15, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @51 { 23, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @52 { 24, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @53 { 26, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @54 { 43, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @55 { 56, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @56 { 57, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @57 { 58, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @58 { 59, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @59 { 60, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @60 { 61, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @61 { 63, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @62 { 287, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @63 { 366, 'b???_????_????, 'b????_????_?0?0_0010, 'b?? : 5; }
        @64 { 1, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @65 { 11, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @66 { 12, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @67 { 13, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @68 { 14, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @69 { 15, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @70 { 23, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @71 { 24, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @72 { 26, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @73 { 43, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @74 { 56, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @75 { 57, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @76 { 58, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @77 { 59, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @78 { 60, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @79 { 61, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @80 { 63, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @81 { 287, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @82 { 366, 'b???_????_????, 'b????_????_?1?0_0010, 'b?? : 9; }
        @83 { 11, 'b???_????_????, 'b????_???1_???1_0000, 'b?? : 2; }
        @84 { 15, 'b???_????_????, 'b????_???1_???1_0000, 'b?? : 2; }
        @85 { 287, 'b???_????_????, 'b????_???1_???1_0000, 'b?? : 2; }
        @86 { 11, 'b???_????_????, 'b????_????_1??1_0000, 'b?? : 2; }
        @87 { 15, 'b???_????_????, 'b????_????_1??1_0000, 'b?? : 2; }
        @88 { 287, 'b???_????_????, 'b????_????_1??1_0000, 'b?? : 2; }
        @89 { 11, 'b???_????_????, 'b????_???0_0??1_0000, 'b?? : 3; }
        @90 { 15, 'b???_????_????, 'b????_???0_0??1_0000, 'b?? : 3; }
        @91 { 287, 'b???_????_????, 'b????_???0_0??1_0000, 'b?? : 3; }
...
;
        8 : SWID_SRC(DERIVE), COMPRESS_KEY(0), AUX_PREC(0), HASH_SIZE0(18), HASH_SIZE1(10), HASH_SIZE2(10), HASH_SIZE3(10), HASH_SIZE4(10), HASH_SIZE5(10), PINNED_LOOKUP(0), AGING_MODE(NONE), 
			// vport_arp_egress_resp_table
			LUT {
				OBJECT_ID(1),
				VSI_LIST_EN(1),
				INV_ACTION(0),
...
;
        3 : SWID_SRC(DERIVE), COMPRESS_KEY(0), AUX_PREC(0), HASH_SIZE0(18), HASH_SIZE1(10), HASH_SIZE2(10), HASH_SIZE3(10), HASH_SIZE4(10), HASH_SIZE5(10), PINNED_LOOKUP(0), AGING_MODE(NONE), 
			// phy_ingress_arp_resp_table
			LUT {
				OBJECT_ID(2),
				VSI_LIST_EN(1),
				INV_ACTION(0),
...
block LEM {
  ...
  domain GLOBAL {
    ...
    owner PROFILE_CFG 1..100 GLOBAL;
    owner OBJECT_CACHE_CFG 0..1 GLOBAL;
    owner HASH_SPACE_CFG 0 GLOBAL;
    owner CACHE_BANK 0..1 GLOBAL;
    owner PROFILE_CFG 0 GLOBAL;
  ...
  domain GLOBAL {
    ...
    table PROFILE_CFG(%PROFILE){
		...
		3 : /* mod_vlan_pop_ctag*/
			...
			GROUP{PID(16), DEL(1)}, 
			GROUP{PID(9), NOP()};
		4 : /* mod_vlan_push_ctag_stag*/
			EXTRACT(0), 
			GROUP{0}, 
			GROUP{PID(9), INS(0,19,4), INS(0,16,4)};
		5 : /* mod_vlan_push_stag*/
			EXTRACT(0), 
			GROUP{0}, 
...
block WLPG_PROFILES {
  ...
  domain GLOBAL {
    ...
    owner WLPG_PROFILE 3500 GLOBAL;
...
block WCM {
  ...
  domain GLOBAL {
    ...
    owner KEY_EXTRACT1 0 GLOBAL;
    owner ACTION_MAP1 0 GLOBAL;
    owner GRP0_SLICE0 0..10 GLOBAL;
    owner GRP0_SLICE1 0..10 GLOBAL;
    owner GRP0_SLICE2 0..10 GLOBAL;
    owner GRP0_SLICE3 0..10 GLOBAL;
    owner PROFILE_CFG1 1..1 GLOBAL;
    owner KEY_EXTRACT1 1..1 GLOBAL;
    owner ACTION_MAP1 1..1 GLOBAL;
    owner GRP1_SLICE0 0..255 GLOBAL;
    owner GRP1_SLICE1 0..255 GLOBAL;
    owner GRP1_SLICE2 0..255 GLOBAL;
    owner GRP1_SLICE3 0..255 GLOBAL;
    owner GRP1_SLICE4 0..255 GLOBAL;
    owner GRP1_SLICE5 0..255 GLOBAL;
    owner GRP1_SLICE6 0..255 GLOBAL;
    owner GRP1_SLICE7 0..255 GLOBAL;
...
block LPM {
  ...
  domain GLOBAL {
    ...
    owner PROFILE_CFG 0..100 GLOBAL;
    owner KEY_EXTRACT 0..1023 GLOBAL;
    owner PROFILE_CFG 0 GLOBAL;
